          ...
          <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
            ...
            <section className="flex my-4 gap-5">
              <div className="flex gap-2">
                <label className="text-white font-medium mt-2 mb-2">Link gae color</label>
                <input
                  type="color"
              ...
              <div className="flex gap-2">
                <label className="text-white font-medium mt-2 mb-2">Link gae background</label>
                <input
                  type="color"
            ...
            <div className="flex items-center justify-start flex-col mb-7 p-1 border-gray-100/25 border rounded-md">
              <label className="text-white font-medium mt-2 mb-3">Check this out:</label>
              <article
